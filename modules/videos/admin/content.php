...
if ($nv_Request->get_int('save', 'post') == 1) {
    ...
    if (empty($rowcontent['title'])) {
        ...
        $error[] = $nv_Lang->getModule('error_vid_path');
    }
        ...
        if ($rowcontent['id'] == 0) {
            ...
            if ($rowcontent['id'] > 0) {
                if (nv_videos_check_uploader(intval($rowcontent['admin_id']))) {
                    ...
                    nv_insert_logs(NV_LANG_DATA, $module_name, $nv_Lang->getModule('add_uploader_data'), $rowcontent['admin_name'], $admin_info['userid']);
                }
...
if (empty($array_cat_check_content)) {
    ...
    $contents = '<div class="alert alert-info"><p class="no_cat">' . $nv_Lang->getModule('note_cat') . '</p><br/>
