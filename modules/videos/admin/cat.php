...
//$nv_Lang->getGlobal('title_suggest_max') = sprintf($lang_global['length_suggest_max'], 65);
//$nv_Lang->getGlobal('description_suggest_max') = sprintf($lang_global['length_suggest_max'], 160);
