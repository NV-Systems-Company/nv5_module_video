...
$array_jw_js = array(
    'true' => $nv_Lang->getGlobal('yes'),
    'false' => $nv_Lang->getGlobal('no')
);
...
$array_sharingsites = array(
    'facebook' => $nv_Lang->getModule('facebook'),
    'twitter' => $nv_Lang->getModule('twitter'),
    'googleplus' => $nv_Lang->getModule('googleplus'),
    'interest' => $nv_Lang->getModule('interest'),
    'tumblr' => $nv_Lang->getModule('tumblr'),
    'reddit' => $nv_Lang->getModule('reddit'),
    'linkedin' => $nv_Lang->getModule('linkedin'),
    'email' => $nv_Lang->getModule('email')
);

$array_jw_position = array(
    'top-right' => $nv_Lang->getModule('jwposition_top-right'),
    'top-left' => $nv_Lang->getModule('jwposition_top-left'),
    'bottom-right' => $nv_Lang->getModule('jwposition_bottom-right'),
    'bottom-left' => $nv_Lang->getModule('jwposition_bottom-left')
);
...
$array_config_source = array(
    $nv_Lang->getModule('config_source_title'),
    $nv_Lang->getModule('config_source_link'),
    $nv_Lang->getModule('config_source_logo')
);
